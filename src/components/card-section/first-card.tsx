...
const FirstCard = () => {
  return (
    <section className='relative col-span-1 flex aspect-video w-full touch-none select-none flex-col items-start justify-start gap-3 rounded-lg border-slate-700/25 bg-gradient-to-b from-slate-500/40 to-transparent p-px md:col-span-2'>
