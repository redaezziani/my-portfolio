...
const SecondCard = () => {
  return (
    <div className="relative flex size-full max-h-52 select-none flex-col items-start justify-start rounded-lg border-slate-700/25 bg-gradient-to-b from-slate-500/40 to-transparent p-px">
