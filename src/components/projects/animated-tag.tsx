...
const AnimatedTag = ({text}: AnimatedTagProps) => {
  return (
    <motion.span
      animate={{ y: -10, x: 2 }}
      transition={{
      ...
      <span className="mt-3 inline-block whitespace-nowrap rounded-full bg-gradient-to-r from-[#1B8EF2] via-[#1BA0F2] to-[#30BBF2] shadow hover:bg-gradient-to-r hover:from-[#1B8EF2] hover:via-[#1BA0F2] hover:to-[#30BBF2] px-2.5 py-1 text-xs   text-white">
       {text}
      </span>
