...
const NavBar = () => {
  ...
  return (
    <>
      ...
      >
        <motion.div
          className={` ${isMenuOpen ? "shadow-lg" : "bg-slate-900"
            } flex flex-col w-full md:max-w-xl  mx-auto items-center rounded-full border border-slate-200 hover:border-slate-300/90 dark:border-slate-800 dark:hover:border-slate-700/90  dark:bg-slate-900/90 transition duration-500 backdrop-blur-sm overflow-hidden`}
        >
          <div
            className={`flex w-full flex-row px-1 py-[0.125rem] justify-between w-full sm:justify-normal ${isMenuOpen
              ...
              <div className="flex">
                {headerTabs.map((headerTab) => (
                  <Link
                    ...
                    className="text-sm px-4 sm:px-3 py-2 text-slate-50 hover:text-slate-800 dark:text-slate-100 dark:hover:text-slate-200 transition duration-500 relative"
                  ...
                  >
                    ...
                    {focused === headerTab.link ? (
                      <motion.div
                        ...
                        className="hidden sm:block absolute top-0 left-0 right-0 w-full h-full bg-slate-200/75 dark:bg-slate-700/50 rounded-full -z-10"
                        layoutId="highlight"
                      />
                    ) : null}
                  </Link>
