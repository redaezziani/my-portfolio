      ...
      >
        <div className='mx-auto mb-8 mt-0 flex h-auto max-w-6xl flex-auto flex-col gap-3 sm:mt-32 sm:h-[37.5rem] sm:flex-1 sm:flex-row'>
          <div className='flex h-[37.5rem] flex-auto flex-col gap-3 sm:flex-1'>
            <div
              className='myself relative inset-0 basis-2/3 overflow-hidden rounded-lg border border-slate-200 bg-cover bg-center shadow-sm hover:border-slate-300 hover:shadow dark:border-slate-800 dark:hover:border-slate-700'
            >
              <Image
                fill
                placeholder='blur'
          ...
          <div className='flex h-[37.5rem] flex-auto flex-col gap-4 sm:flex-1'>
            <div
              ...
              className='group flex basis-1/2 flex-col items-end justify-center overflow-hidden rounded-lg border border-slate-200 bg-[#FAFCFF] shadow-sm hover:border-slate-300 dark:border-slate-800 dark:bg-slate-900 dark:hover:border-slate-700'
            >
              <motion.div
                initial={'notHover'}
                whileHover={'isHover'}
                className="inset-0 flex h-full w-full items-center justify-center bg-[url('./images/HabbitBackgroundtop.png')] bg-cover bg-bottom"
              >
                <motion.img
                ...
                <motion.img
                  ...
                  className='z-10 ml-1 h-auto w-[3.5rem]'
                  src={paths.mysql}
                  alt='mysql'
                />
                <motion.img
            ...
            >
              <motion.div
                initial={'notHover'}
                whileHover={'isHover'}
                className="relative inset-0 flex h-full w-full items-center justify-center bg-[url('./images/HabbitBackgroundbottom.png')] bg-cover bg-bottom"
              >
                <motion.img
                  ...
                  className='absolute top-2 h-[0.875rem] w-auto'
                  src={paths.code01}
                  alt='Code'
                />
                <motion.img
              ...
              <div className='flex w-full flex-col px-6 pb-6'>
                ...
                <div className='mt-2 line-clamp-3 text-sm leading-[1.4rem] text-slate-600 dark:text-slate-400'>
                  ...
                  mind, I started exploring how to build web pages to showcase
                  my work perfectly. Slowly, I entered a new field...
                </div>
              </div>
            </div>
          </div>
          <div className='flex h-[37.5rem] flex-auto flex-col gap-4 sm:flex-1'>
            <div
              ...
              className="relative inset-0 flex basis-1/3 items-end justify-center overflow-hidden rounded-lg border border-white bg-[url('./images/Habbit-1.jpg')] bg-cover bg-center shadow-sm hover:shadow dark:border-slate-900"
            >
              <div className='absolute z-10 h-full w-full bg-gradient-to-b from-[#02061700] to-[#02061773]'></div>
              ...
              <div className='z-30 flex w-full flex-col bg-gradient-to-b from-[#02061700] to-[#02061773] px-8 pb-5 pt-1'>
                ...
                <div className='text-sm font-normal text-white/[0.65]'>
                  Diving into various sports, embracing the thrill of
            ...
            <div
              ...
              className="bg-primary-600 relative inset-0 flex basis-1/3 items-end justify-center overflow-hidden rounded-lg border border-white bg-[url('./images/Habbit-2.jpg')] bg-cover bg-center shadow-sm hover:shadow dark:border-slate-900"
            >
              <div
                
               
                className='absolute z-10 h-full w-full bg-gradient-to-b from-[#02061700] to-[#02061773]'
              ></div>
              <div className='z-30 flex w-full flex-col bg-gradient-to-b from-[#02061700] to-[#02061773] px-8 pb-5 pt-1'>
                <div className='text-base font-medium text-white'>
            ...
            <div
              ...
              className="bg-primary-600 relative inset-0 flex basis-1/3 items-end justify-center overflow-hidden rounded-lg border border-white bg-[url('./images/Habbit-3.jpg')] bg-cover bg-center shadow-sm hover:shadow dark:border-slate-900"
            >
              <div className='absolute z-10 h-full w-full bg-gradient-to-b from-[#02061700] to-[#02061773]'></div>
