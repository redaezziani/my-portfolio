                            ...
                            <div className="z-10 mt-4 flex items-center justify-start gap-2 px-2 text-sm  text-slate-500 dark:text-slate-200">
                                <div className="z-10 flex size-full flex-col items-start justify-end gap-3">
                                    ...
                                    <div className="mt-1 flex w-full flex-wrap gap-2">
                                        <div className=" flex items-start justify-start gap-2  rounded-lg border border-slate-100/35 px-2 py-1 font-medium">
                                            <DraftingCompass className=" text-white" size={14} />
                                            <p className="text-xs text-white">new design</p>
                                        </div>
                                        <div className=" flex items-start justify-start gap-2  rounded-lg border border-slate-100/35 px-2 py-1 font-medium">
                                            <svg
                                            ...
                                            >
                                                ...
                                                />
                                                <path
                                                    d="M10.125 17.5L10.125 11.5M12 11.5V10M12 19V17.5M10.125 14.5H13.875M13.875 14.5C14.4963 14.5 15 15.0037 15 15.625V16.375C15 16.9963 14.4963 17.5 13.875 17.5H9M13.875 14.5C14.4963 14.5 15 13.9963 15 13.375V12.625C15 12.0037 14.4963 11.5 13.875 11.5H9"
                                                    stroke="currentColor"
                                                    strokeWidth="1.5"
                                                    strokeLinecap="round"
                                            ...
                                            <p className="text-xs text-white">save mony</p>
                                        </div>
                                        <div className=" flex items-start justify-start gap-2  rounded-lg border border-slate-100/35 px-2 py-1 font-medium">
                                            <DraftingCompass className=" text-white" size={14} />
                                            <p className="text-xs text-white">new design</p>
                                        ...
                                        <div className=" flex items-start justify-start gap-2 rounded-lg  border border-dashed border-slate-100/35 px-2 py-1 font-medium">
                                            <DraftingCompass
                                                className=" text-white opacity-0 "
                                                size={14}
                                            />
                                            <p className="text-xs text-white opacity-0">new design</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
