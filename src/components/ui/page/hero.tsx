    ...
    <>
      ...
      >
        <div className={`absolute inset-0 -z-[1] bg-cover`}>
          <div
            className="h-full w-full bg-[url('./images/decorationBlockLight.svg')] bg-repeat dark:bg-[url('./images/decorationBlockDark.svg')]"
            style={{
              WebkitMaskImage:
        ...
        <motion.div
          ...
          initial={'hidden'}
          animate={'show'}
          className='font-Inter relative mx-auto inline-block bg-gradient-to-b from-slate-950 to-slate-700 bg-clip-text pt-40 text-4xl font-bold leading-tight text-transparent dark:from-slate-50 dark:to-slate-200 sm:pt-60 sm:text-5xl sm:leading-tight lg:text-6xl lg:leading-tight'
        >
          Reda.
          <br />
          Ezziani.
